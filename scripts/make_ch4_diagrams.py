...
# ---- Fig 4.10  ASL training curve (redrawn) ---------------------------------
...
ax.plot(e, tr_acc, color="#f59e0b", lw=1.6, label="train accuracy")
ax.plot(e, val_acc, color="#2563eb", lw=1.6, label="val accuracy")
ax.set_xlabel("Epoch"); ax.set_ylabel("Categorical accuracy"); ax.set_ylim(0, 0.9)
ax.axhline(0.80, color="#2563eb", ls=":", lw=1)
ax.text(360, 0.81, "val ≈ 0.80", fontsize=8, color="#2563eb")
ax2 = ax.twinx()
ax2.plot(e, tr_loss, color="#16a34a", lw=1.4, label="train loss")
ax2.plot(e, val_loss, color="#dc2626", lw=1.4, label="val loss")
ax2.set_ylabel("Loss"); ax2.set_ylim(0, 5)
ax.set_title("Figure 4.10  —  ASL training curve (redrawn from log)", fontsize=11.5, weight="bold", color=TXT)
