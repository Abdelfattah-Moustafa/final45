...
# ---- Fig 5.4  Recognition accuracy ------------------------------------------
fig, ax = plt.subplots(figsize=(6.5, 4.2))
labels = ["ASL (250-class)\nTop-1", "ArSL (20-class)\nTop-1"]
acc = [0.624, 0.9941]
bars = ax.bar(labels, acc, color=[C_ASL, C_AR], width=0.5)
ax.bar_label(bars, labels=[f"{a*100:.1f}%" for a in acc], fontsize=11, weight="bold")
ax.set_ylabel("Top-1 accuracy"); ax.set_ylim(0, 1.05)
finish(fig, ax, "Figure 5.4  —  Isolated-sign recognition accuracy", "fig5_04_recognition.png")
